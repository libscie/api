...
const validate = (exports.validate = (indexMetadata, dbMetadata) => {
    ...
    _validateP2pcommons(indexMetadata, dbMetadata)
    // etc.
})
...
const _validateP2pcommons = (indexMetadata, dbMetadata) => {
...
const validateSubtype = (exports.validateSubtype = (indexMetadata) => {
    ...
    _validateSubtypeAlphanumeric(indexMetadata)
})
...
const _validateSubtypeAlphanumeric = (indexMetadata) => {
...
const validateMainExists = (exports.validateMainExists = (indexMetadata) => {
    // Only called upon registration
})
