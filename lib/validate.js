...
const validate = (exports.validate = (indexMetadata, dbMetadata, hyperdriveKey) => {
    validateTitle(indexMetadata)
    validateDescription(indexMetadata)
    validateUrl(indexMetadata, hyperdriveKey)
    validateLinks(indexMetadata)
    validateP2pcommons(indexMetadata, dbMetadata, hyperdriveKey)
})

exports.validateBeforeInit = (indexMetadata) => {
    validateTitle(indexMetadata)
    validateDescription(indexMetadata)
    validateP2pcommons(indexMetadata, {}, "")
}

exports.validateOnRegister = (indexMetadata, dbMetadata, hyperdriveKey, p2pcommonsDir) => {
    validateMainExists(indexMetadata, hyperdriveKey, p2pcommonsDir)
    validate(indexMetadata, dbMetadata, hyperdriveKey)
}

exports.validateOnUpdateParents = async (indexMetadata, dbMetadata, hyperdriveKey, p2pcommons) => {
    await validateParentsRegistered(indexMetadata, p2pcommons)
    validate(indexMetadata, dbMetadata, hyperdriveKey)
}
...
const validateUrl = (exports.validateUrl = (indexMetadata, hyperdriveKey) => {
...
const validateP2pcommons = (exports.validateP2pcommons = (indexMetadata, dbMetadata, hyperdriveKey) => {
    ...
    validateParents(indexMetadata, dbMetadata, hyperdriveKey)
    validateFollows(indexMetadata, hyperdriveKey)
...
const validateMainExists = (exports.validateMainExists = (indexMetadata, hyperdriveKey, p2pcommonsDir) => {
...
const validateParents = (exports.validateParents = (indexMetadata, dbMetadata, hyperdriveKey) => {
...
const validateFollows = (exports.validateFollows = (indexMetadata, hyperdriveKey) => {
...
exports.unflattenIndexMetadata = indexMetadata => {
    if (indexMetadata.p2pcommons === undefined) {
        indexMetadata.p2pcommons = {}
        for (const p2pcommonsKey of ['type', 'subtype', 'main', 'avatar', 'authors', 'parents', 'follows', 'contents']) {
