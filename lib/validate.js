...
exports.validate = (indexMetadata, dbMetadata, hyperdriveKey, p2pcommonsDir, unflatten = true) => {
    if (unflatten) {
        indexMetadata = _unflattenIndexMetadata(indexMetadata)
    }
    _validateMainExists(indexMetadata, hyperdriveKey, p2pcommonsDir, unflatten)
    validateDraft(indexMetadata, dbMetadata, hyperdriveKey, unflatten)
}

const validateDraft = (exports.validateDraft = (indexMetadata, dbMetadata, hyperdriveKey, unflatten = true) => {
    if (unflatten) {
        indexMetadata = _unflattenIndexMetadata(indexMetadata)
    }
...
exports.validateMain = (indexMetadata, hyperdriveKey, p2pcommonsDir, unflatten = true) => {
    if (unflatten) {
        indexMetadata = _unflattenIndexMetadata(indexMetadata)
    }
    validateMainDraft(indexMetadata, unflatten)
...
const _validateMainExists = (indexMetadata, hyperdriveKey, p2pcommonsDir, unflatten = true) => {
    if (unflatten) {
        indexMetadata = _unflattenIndexMetadata(indexMetadata)
    }
    assert(
